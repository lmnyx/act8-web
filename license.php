<head>
    <title>act8 | Legal Information</title>
...
<div class="pagecontent">
	...
	<p>act8 may collect any or all of the following information:
		<ul>
			<li>name of your PC</li>
			<li>Your PC specs</li>
			<li>Your contact information</li>
			<li>Preferences and interests</li>
			<li>ISP information and address</li>
			<li>Geolocation</li>
	...
	<p>You may restrict collection of your personal information in the following ways:
		<ul>
			...
			<li>Whenever you are asked to fill in a form, look for the box that you can click to indicate that you do not want the information to be used by anybody for direct marketing purposes</li>
			<li>If you have previously agreed to act8 to using your personal information for direct marketing purposes, you may change your mind at any time using in-game or/and in-service settings menu.</li>
		</ul></p>
	<p>Everyone related to act8 will be next discribed as act8 members.</p>
	<p>All act8 members agrees to give additional personal information collection to improve projects.</p>
	<p>All act8 members agrees to do not distribute any information in any form given to them and/or their mates.</p>
	<p>All users and/or players agrees to license agreement.</p>
	<p>Any formers of act8 <span style="color: #FE006C;">may not</span> comply with this agreement.</p>
	<p>Developers of act8 can violate the license to test <span style="color: #FE006C;">uncompleted</span> project or update.</p>
	<p>act8 can change legal information from time to time by updating this page. You are obligated to check this page each time you wish or/and logging into a game, service or/and website to ensure that you are in agreement with any and all changes.</p>
	<p>Any violation will continue with punishment in not disclared form based on severity.</p>
	<p>This page contains either Privacy Policy, License, NDA and EULA.</p>
	<p style="color: #444;">Legal Information was last updated 11/24/19</p>
</div>